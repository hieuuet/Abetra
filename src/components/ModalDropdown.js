/**
 * coppy by: https://github.com/sohobloo/react-native-modal-dropdown
 */
"use strict";
      ...
      >
        {children || (
          <View style={styles.button}>
            <Text
              style={[styles.buttonText, textStyle, { flex: 1 }]}
              numberOfLines={1}
            >
              {buttonText}
            </Text>
            {this.props.leftIcon || this.props.listIcon ? (
              <Image
                source={
                  this.props.leftIcon
                    ? this.props.leftIcon
                    : { uri: this.props.listIcon[this.state.selectedIndex] }
                }
                resizeMode="cover"
                style={{
                  width: 20,
    ...
    const row = !renderRow ? (
      this.props.listIcon ? (
        ...
        >
          ...
          <Image
            source={{ uri: this.props.listIcon[rowID] }}
            resizeMode="cover"
            style={{
              width: 20,
              height: 20
