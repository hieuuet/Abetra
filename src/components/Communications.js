...
export const email = function(to, cc, bcc, subject, body) {
  ...
  switch (argLength) {
    ...
    default:
      console.log(
        `you must supply either 0 or 5 arguments. You supplied ${argLength}`
      );
      return;
  }
...
export const text = function(phoneNumber = null, body = null) {
  ...
  if (phoneNumber) {
    if (isCorrectType("String", phoneNumber)) {
      ...
      console.log(
        `the phone number should be provided as a string. It was provided as ${Object.prototype.toString
          .call(phoneNumber)
...
export const web = (address = null) => {
  ...
  if (!isCorrectType("String", address)) {
    console.log(
      `address was not provided as a string, it was provided as ${Object.prototype.toString
        .call(address)
        .slice(8, -1)}`
    );
    return;
