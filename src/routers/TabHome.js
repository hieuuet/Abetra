      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor, focused }) => (
          <Image
            ...
            source={
              focused
                ? require("../../assets/tab/icon_feed_active.png")
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor, focused }) => (
          <Image
            ...
            source={
              focused
                ? require("../../assets/tab/icon_service_active.png")
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor, focused }) => (
          <Image
            ...
            source={
              focused
                ? require("../../assets/tab/icon_forcus_active.png")
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor, focused }) => (
          <Image
            ...
            source={
              focused
                ? require("../../assets/tab/icon_moretop_active.png")
