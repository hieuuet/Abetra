...
class CreatePost extends Component {
  ...
  Push = index => {
    ...
    ArrMoi.push({
      OptionContent: `${this.TEXT_CREATE_POST.Option} ${index + 2}`
    });
    this.setState({
      ArrOptions: ArrMoi
    });
        ...
        <View style={styles.view_container}>
          ...
          <View style={styles.view_bottom}>
            ...
            {this.state.isEvent ? (
              <View>
                <TextInput
                  ...
                  autoCapitalize="none"
                  returnKeyType="next"
                  placeholder={this.TEXT_CREATE_POST.TitleEvent}
                ...
                >
                  <Text>{this.TEXT_CREATE_POST.TimeStart}</Text>
                  <DatePicker
                    style={{ width: "100%" }}
                    ...
                    onDateChange={datetime => {
                      this.setState({ TimeStart: datetime }, () =>
                        console.log("datetime1", this.state.TimeStart)
                      );
                    }}
                  />
                </View>
                <TextInput
                  ...
                  autoCapitalize="none"
                  returnKeyType="next"
                  placeholder={this.TEXT_CREATE_POST.Address}
            ...
            <Text style={{ marginLeft: 10, marginTop: 10 }}>
              {this.TEXT_CREATE_POST.AddToPost}
            </Text>
              ...
              <TouchableOpacity onPress={() => this._createVote()}>
                <View style={styles.view_vote}>
                  <Text style={{ marginLeft: 5, fontSize: 12, marginRight: 5 }}>
                    {this.TEXT_CREATE_POST.PollVote}
                  </Text>
                  {this.state.isVote ? (
                    <TouchableOpacity
                      onPress={() =>
