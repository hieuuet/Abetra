...
class Menu extends Component {
    ...
    render() {
        ...
        return (
            <View style={{flexDirection: "column", backgroundColor: "white", justifyContent: "space-between", flex:1}}>
                <View>
                    {this.renderHeader()}
                    <MenuItem
                ...
                <View style = {{flexDirection:'row', alignItems: 'center', marginHorizontal:20, justifyContent: 'space-between', marginBottom: 10, paddingBottom: 2}}>
